    ...
    <section class="base-menu" :class="{ 'is-visible': isVisible }">
        <ul class="menu__list">
            <li class="menu__header">
                ...
                <div class="location"><icon-svg icon="location" />江西丰城</div>
                <a-row class="social-list">
                    ...
                    <a-col :span="8">
                        <a title="github" href="https://github.com/zouzuhao" target="_blank">
                            <icon-svg icon="github" :size="24" />
                        </a>
                    </a-col>
                    <a-col :span="8">
                        <a title="掘金" href="https://juejin.cn/user/814061686368334" target="_blank">
            ...
            <li class="menu__item">
                <a href="#" target="_blank"><icon-svg icon="chat" />随心聊Chat</a>
            </li>
            <li class="menu__item">
